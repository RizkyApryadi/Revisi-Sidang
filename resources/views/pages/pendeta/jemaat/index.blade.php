    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
                ...
                <a href="{{ route('pendeta.jemaat.create') }}" class="btn btn-primary">
        ...
        <div class="card-body pt-2">
            ...
            <table class="table table-bordered table-striped w-100">
                ...
                <tbody class="align-middle">
                    @foreach($keluargasWithWijk as $idx => $kel)
                    <tr>
                        ...
                        <td class="text-center">{{ $kel->jemaats_count ?? ($kel->jemaats->count() ?? 0) }}</td>
                        <td class="text-center" style="white-space: nowrap;">
                            <a href="#" class="btn btn-info btn-sm mr-1" title="Lihat"><i class="fas fa-eye"></i></a>
                            <a href="#" class="btn btn-warning btn-sm mr-1" title="Edit"><i class="fas fa-edit"></i></a>
