...
<nav id="navbar" class="w-full bg-white border-b">
    <div class="max-w-[1400px] mx-auto px-8 flex justify-center">
        <ul class="flex items-center justify-center gap-10 text-sm font-semibold uppercase tracking-wide text-slate-800 py-3">
            ...
            <li class="relative">
                <button data-dropdown-toggle aria-controls="aboutMenu" aria-expanded="false"
                    ...
                    Tentang
                    <svg class="w-4 h-4 mt-[1px]" xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <ul id="aboutMenu"
                    class="absolute left-0 mt-3 w-48 bg-white border shadow-lg text-sm text-slate-700
                           transform origin-top scale-y-0 opacity-0 pointer-events-none
                           transition-all duration-200 ease-out z-50">

                    <li>
                        <a href="{{ route('guest.jadwal') }}"
