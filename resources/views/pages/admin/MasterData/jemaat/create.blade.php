                        ...
                        <form action="{{ route('admin.jemaat.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="ayah_no_hp" class="form-control">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>No HP Ibu</label>
                                        <input type="text" name="ibu_no_hp" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label>Email Ayah</label>
                                        <input type="email" name="ayah_email" class="form-control">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>Email Ibu</label>
                                        <input type="email" name="ibu_email" class="form-control">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="anak-wrapper">
                                ...
                                <div class="anak-item border rounded p-3 mb-3" data-index="0">
                                    ...
                                    <input type="text" name="anak[0][nomor_hp]" class="form-control mt-2"
                                        placeholder="Nomor HP Anak (opsional)">

                                    <input type="text" name="anak[0][email]" class="form-control mt-2"
                                        placeholder="Email Anak (opsional)">
